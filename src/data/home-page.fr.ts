...
export const homePageFr: HomePageCopy = {
  ...
  works: {
    ...
    provisionsCard: {
      image: '/assets/markets/fr/app/screen-provisions.png',
      imageWidth: 1076,
      imageHeight: 792,
    ...
    exportCard: {
      image: '/assets/markets/fr/app/report-mileage.png',
      imageWidth: 2000,
      imageHeight: 1764,
    ...
    settingsCard: {
      image: '/assets/markets/fr/app/screen-settings.png',
      imageWidth: 1642,
      imageHeight: 1202,
  ...
  team: {
    ...
    tryLabel: 'Tester gratuitement pendant 3 mois',

...
export const homePageFr: HomePageCopy = {
  hero: {
    ...
    collage: {
      ...
      desktopWidth: 1618,
      desktopHeight: 1010,
      tabletSrc: '/assets/app/step-settings-wide.fr.jpg',
  ...
  testimonialsBackground: '/assets/photos/laptop-app.fr.jpg',
  ...
  works: {
    ...
    importCard: {
      image: '/assets/app/step-calendar-import.fr.png',
      imageWidth: 2000,
      imageHeight: 1334,
    ...
    provisionsCard: {
      image: '/assets/app/step-provisions.fr.png',
      imageWidth: 2000,
      imageHeight: 1299,
    ...
    exportCard: {
      image: '/assets/app/step-mileage-export.fr.png',
      imageWidth: 2000,
      imageHeight: 1764,
    ...
    settingsCard: {
      image: '/assets/app/step-settings.fr.png',
      imageWidth: 2000,
      imageHeight: 1454,
  ...
  team: {
    ...
    image: '/assets/app/screen-claims-list.fr.png',
    imageAlt: 'izika team',
    imageWidth: 920,
    imageHeight: 719,
  },

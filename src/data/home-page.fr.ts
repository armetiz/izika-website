...
export const homePageFr: HomePageCopy = {
  hero: {
    ...
    collage: {
      ...
      desktopWidth: 1618,
      desktopHeight: 1010,
      tabletSrc: '/assets/markets/fr/app/step-settings-wide.jpg',
  ...
  testimonialsBackground: '/assets/markets/fr/photos/laptop-app.jpg',
  ...
  works: {
    ...
    importCard: {
      image: '/assets/markets/fr/app/step-calendar-import.png',
      imageWidth: 2000,
      imageHeight: 1334,
    ...
    provisionsCard: {
      image: '/assets/markets/fr/app/step-provisions.png',
      imageWidth: 2000,
      imageHeight: 1299,
    ...
    exportCard: {
      image: '/assets/markets/fr/app/step-mileage-export.png',
      imageWidth: 2000,
      imageHeight: 1764,
    ...
    settingsCard: {
      image: '/assets/markets/fr/app/step-settings.png',
      imageWidth: 2000,
      imageHeight: 1454,
  ...
  calendarLogos: [
    { src: '/assets/integrations/google.svg', alt: "Import d'IK depuis Google Agenda" },
    { src: '/assets/integrations/icloud.svg', alt: "Import d'IK depuis iCloud" },
    { src: '/assets/integrations/outlook.svg', alt: "Import d'IK depuis Microsoft Outlook" },
    { src: '/assets/integrations/office365.png', alt: "Import d'IK depuis Microsoft Office 365" },
    { src: '/assets/integrations/ics.svg', alt: "Import d'IK depuis fichier ICS" },
    { src: '/assets/integrations/dolibarr.png', alt: "Import d'IK depuis Dolibarr" },
  ],
  team: {
    ...
    image: '/assets/markets/fr/app/screen-claims-list.png',
    imageAlt: 'izika team',
    imageWidth: 920,
    imageHeight: 719,
  },

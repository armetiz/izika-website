...
export const homePageUk: HomePageCopy = {
  hero: {
    ...
    collage: {
      desktopSrc: '/assets/markets/uk/app/screen-next-stop.jpg',
      desktopAlt: 'izika on a desktop computer',
      desktopWidth: 1618,
      desktopHeight: 1210,
      tabletSrc: '/assets/markets/uk/app/screen-settings.png',
      tabletAlt: 'izika on a tablet',
      tabletWidth: 1642,
      tabletHeight: 1202,
      ipadSrc: '/assets/markets/uk/app/report-mileage.png',
  ...
  testimonialsBackground: '/assets/markets/uk/photos/laptop-app.jpg',
  ...
  works: {
    ...
    provisionsCard: {
      image: '/assets/markets/uk/app/screen-provisions.png',
      imageWidth: 1076,
      imageHeight: 792,
    ...
    exportCard: {
      image: '/assets/markets/uk/app/report-mileage.png',
      imageWidth: 2000,
      imageHeight: 1764,
    ...
    settingsCard: {
      image: '/assets/markets/uk/app/screen-settings.png',
      imageWidth: 1642,
      imageHeight: 1202,
  ...
  team: {
    ...
    tryLabel: 'Try free for 3 months',
    image: '/assets/markets/uk/app/screen-claims-list.png',
    imageAlt: 'izika team',
    imageWidth: 920,
    imageHeight: 719,
  },
  pricing: {
    ...
    plans: [
      ...
      },
      {
        ...
        ctaLabel: 'Try free for 3 months',
      },
    ],
  },
};

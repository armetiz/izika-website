...
export const homePageUk: HomePageCopy = {
  hero: {
    ...
    collage: {
      desktopSrc: '/assets/markets/uk/app/screen-next-stop-wide.jpg',
      desktopAlt: 'izika on a desktop computer',
      desktopWidth: 1618,
      desktopHeight: 1010,
      tabletSrc: '/assets/markets/uk/app/step-settings-wide.jpg',
  ...
  works: {
    ...
    importCard: {
      image: '/assets/markets/uk/app/step-calendar-import.png',
      imageWidth: 2000,
      imageHeight: 1334,
    ...
    provisionsCard: {
      image: '/assets/markets/uk/app/step-provisions.png',
      imageWidth: 2000,
      imageHeight: 1299,
    ...
    exportCard: {
      image: '/assets/markets/uk/app/step-mileage-export.png',
      imageWidth: 2000,
      imageHeight: 1764,
    ...
    settingsCard: {
      image: '/assets/markets/uk/app/step-settings.png',
      imageWidth: 2000,
      imageHeight: 1454,
